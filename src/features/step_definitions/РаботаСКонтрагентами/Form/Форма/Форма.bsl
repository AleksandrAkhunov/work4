...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"СоздаемЭлементСправочникаСНаименованием(Парам01)","СоздаемЭлементСправочникаСНаименованием","Тогда создаем элемент справочника с наименованием ""Контрагент2""");
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ПереименовываемЭлементСправочникаСНаименованиемВ(Парам01,Парам02)","ПереименовываемЭлементСправочникаСНаименованиемВ","ТОгда переименовываем элемент справочника с наименованием ""Контрагент"" в ""Контрагент1""");
