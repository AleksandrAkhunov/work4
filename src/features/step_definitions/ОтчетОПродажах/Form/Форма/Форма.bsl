...
Функция ПолучитьСписокТестов(КонтекстФреймворкаBDD) Экспорт
	...
	Ванесса.ДобавитьШагВМассивТестов(ВсеТесты,"ЯПодготоваливаюВспомогательныеДанныеДляПроверкиОтчетаОПродажах()","ЯПодготоваливаюВспомогательныеДанныеДляПроверкиОтчетаОПродажах","Допустим я подготоваливаю вспомогательные Данные для проверки отчета о продажах");
...
Процедура ЯПодготоваливаюВспомогательныеДанныеДляПроверкиОтчетаОПродажах() Экспорт
	...
	ЗагрузитьFixtureИзМакета("Продажа");
КонецПроцедуры
